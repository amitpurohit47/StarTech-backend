...
import { createTeacher, loginTeacher, fetchClass, fetchallClasses, addSubjectTeachers, fetchStudyMaterial, addStudyMaterial, addNotice, allNotices, addMark, allMark, fetchAttendence, addAttendence } from "../controllers";
...
TeacherRouter.get("/fetchAttendence", fetchAttendence);
